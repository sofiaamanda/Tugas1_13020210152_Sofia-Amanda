          ...
          <div class="container">
            ...
            <ul class="nav nav-pills" style="margin-left: 15vw;">
              <li class="dropdown active item-kategori">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Cupang<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a data-toggle="tab" href="#tabel-serit">Serit</a></li>
                  <li><a data-toggle="tab" href="#tabel-halfmoon">Halfmoon</a></li>                     
                </ul>
              </li>
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-tetra">Ikan Tetra</a></li>
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-discus">Ikan Discus</a></li>              
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-koi">Ikan Koi</a></li>
            </ul>
          </div>
